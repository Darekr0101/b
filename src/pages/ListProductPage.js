...
import { getProductListByCategoryAndSubcategory, getProductList, getProductListKeyword } from 'actions/services/ProductServices'
...
function ListProductPage(props) {
    ...
    useEffect(() => {
        ...
        if (category !== '' && category) {
            ...
            getProductListKeyword(searchObject)
                .then((res) => {
