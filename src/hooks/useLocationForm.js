...
async function fetchCityOptions() {
    ...
    const locations = await (await axios.get(url, { headers : headers})).data.data
...
function useLocationForm() {
    ...
    useEffect(() => {
        (async function () {
            if (shouldFetchInitialLocation) {
                ...
                const options = await (await axios.get('https://dev-online-gateway.ghn.vn/shiip/public-api/master-data/province',{headers: headers})).data.data;
                setState({
    ...
    useEffect(() => {
        (async function () {
            ...
            const options = await 
            (await axios.get(`https://dev-online-gateway.ghn.vn/shiip/public-api/master-data/district?province_id=${selectedCity.value}`, {headers : headers})
            ).data.data
            setState({
    ...
    useEffect(() => {
        (async function () {
            ...
            const options = await (await axios.get(`https://dev-online-gateway.ghn.vn/shiip/public-api/master-data/ward?district_id=${selectedDistrict.value}`, {headers: headers})).data.data
            setState({
